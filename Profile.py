...
# OR UNDERSTAND THE JSON SERIALIZATION ASPECTS OF THIS CODE
...
class Profile:
    ...
    ***** NEW ADDED THIS: Get friends list ******

    '''

    def get_friends(self) -> list[Post]:
        return self.friends
    
    '''
    
    ***** ADDED THIS: Get messages list ******

    '''

    def get_messages(self) -> list[Post]:
            ...
            try:
                ...
                if obj['messages']:
                    for message_obj in obj['messages']:
                        message = DirectMessage(message_obj['recipient'], message_obj['message'], message_obj['timestamp'])
                        self.messages.append(message)
    ...
    def get_friend_messages(self, friend):
        messages = []
